...
<section class="mx-auto px-4 py-8 bg-base-200 animate__animated animate__fadeIn">
    <div class="flex justify-between items-center mb-6 bg-base-200 pb-4">
        ...
        <a wire:navigate href="{{ route('products', ["tags[]=$tag->id"]) }}"
            class="btn btn-link hover:scale-105 transition-transform text-sm sm:text-base whitespace-nowrap">View All
            →</a>
    </div>
