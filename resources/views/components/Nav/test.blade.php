...
<div>
            ...
            <div class="mt-10 pt-6 border-t border-base-300/50">
                @auth
                    <a href="{{ route('profile') }}" wire:navigate
                        class="group flex items-center py-4 px-5 rounded-2xl text-sm font-medium hover:bg-base-200/70 hover:text-primary transition-all duration-300 transform hover:scale-[1.02] border border-transparent hover:border-base-300">
                        <div class="flex items-center space-x-4">
                            <div
                                class="p-2 rounded-xl bg-base-200 group-hover:bg-primary/10 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @else
                    <a wire:navigate href="{{ route('login') }}"
                        class="flex items-center justify-center py-4 px-6 rounded-2xl text-sm font-semibold bg-gradient-to-r from-primary to-secondary text-primary-content hover:shadow-lg transform hover:scale-105 transition-all duration-300 group">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 mr-3 group-hover:translate-x-1 transition-transform duration-300"
    ...
    {{-- Main Navbar --}}
    <div class="navbar bg-base-100/80 backdrop-blur-lg sticky top-0 z-30 border-b border-base-300/50 py-3 lg:py-2">
        ...
        <div class="navbar-center hidden lg:flex">
            <div class="bg-base-200/50 rounded-2xl p-2 backdrop-blur-sm border border-base-300/50">
        ...
        <div class="navbar-end gap-3 lg:gap-2">
            @auth
                {{--
                IMPORTANT FIX:
                The x-cart-drawer component needs a higher z-index to appear above the main navbar.
                GO TO your 'resources/views/components/cart-drawer.blade.php' file.
                Find the outermost div or main container of the cart drawer (it should likely be 'fixed' or 'absolute').
                Add 'z-40' (or a similar high z-index, e.g., z-45) to its class list.
                Example in cart-drawer.blade.php:
                <div id="cart-drawer" class="fixed ... z-40">
            --}}
                <x-cart-drawer />
                <div class="dropdown dropdown-end">
                    <div tabindex="0" role="button"
                        class="btn btn-ghost btn-circle avatar hover:scale-110 transition-all duration-300 ring-2 ring-transparent hover:ring-primary/30">
                        <div class="w-8 lg:w-10 rounded-full bg-gradient-to-r from-primary to-secondary p-0.5">
                    ...
                    <ul tabindex="0"
                        class="menu menu-sm dropdown-content bg-base-100 rounded-2xl z-[1] mt-3 w-52 p-3 shadow-xl border border-base-300/50 backdrop-blur-sm">
                        <li>
                            <a href="{{ route('profile') }}" wire:navigate
                                class="py-3 px-4 rounded-xl hover:bg-primary/10 hover:text-primary transition-all duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            ...
            @else
                <a wire:navigate href="{{ route('login') }}"
                    class="btn btn-primary btn-sm rounded-xl text-primary-content hover:shadow-lg transform hover:scale-105 transition-all duration-300 px-6">
